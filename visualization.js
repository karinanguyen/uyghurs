...
// const categories = ['Afghanistan', 'Argentina', 'Australia', 'Azerbaijan', 'Bangladesh', 'Belgium',
// 'Bermuda','Brazil', 'Cambodia','Canada', 'Egypt','Fiji', 'France', 'Hong Kong','India','Iran',
// 'Iraq','Israel','Macao','Malaysia','Morocco','Myanmar','North Korea', 'Pakistan','Russia','Singapore','South Korea', 'Taiwan','Thailand',
// 'United Kingdom','United States','Uruguay','Venezuela']

// // 3 - circulation, 4 - percentage s
// const categoriesXY = {'Afghanistan': [0, 400, 57382, 0.16],
//                         'Argentina': [0, 600, 43538, 48.3],
//                         'Australia': [0, 800, 41890, 50.9],
//                         'Azerbaijan': [0, 200, 42200, 48.3],
//                         'Bangladesh': [200, 400, 42745, 31.2],
//                         'Belgium': [200, 600, 36900, 40.5],
//                         'Bermuda': [200, 800, 36342, 35.0],
//                         'Brazil': [200, 200, 33062, 60.4],
//                         'Cambodia': [400, 400, 36825, 79.5],
//                         'Canada': [400, 600, 37344, 55.4],
//                         'Egypt': [400, 800, 36421, 58.7],
//                         'Fiji': [400, 200, 32350, 74.9],
//                         'France': [600, 400, 31913, 63.2],
//                         'Hong Kong': [600, 600, 30100, 79.4],
//                         'India': [600, 600, 30100, 79.4],
//                         'Iran' : [600, 600, 30100, 79.4],
//                         'Iraq':[600, 600, 30100, 79.4],
//                         'Israel':[600, 600, 30100, 79.4],
//                         'Macao':[600, 600, 30100, 79.4],
//                         'Malaysia':[600, 600, 30100, 79.4],
//                         'Morocco':[600, 600, 30100, 79.4],
//                         'Myanmar':[600, 600, 30100, 79.4],
//                         'North Korea':[600, 600, 30100, 79.4], 
//                         'Pakistan':[600, 600, 30100, 79.4],
//                         'Russia':[600, 600, 30100, 79.4],
//                         'Singapore':[600, 600, 30100, 79.4],
//                         'South Korea':[600, 600, 30100, 79.4], 
//                         'Taiwan':[600, 600, 30100, 79.4],
//                         'Thailand':[600, 600, 30100, 79.4],
//                         'United Kingdom':[600, 600, 30100, 79.4],
//                         'United States':[600, 600, 30100, 79.4],
//                         'Uruguay':[600, 600, 30100, 79.4],
//                         'Venezuela':[600, 600, 30100, 79.4]}
